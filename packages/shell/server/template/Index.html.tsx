...
import App from '@shell/client/App';
import routes from '@shell/client/routes';
import Javascript from '@shell/server/template/components/Javascript.html';
import Stylesheets from '@shell/server/template/components/Stylesheets.html';
import { HttpContextData, HttpProvider } from '@shell/client/contexts/http';
import { AppStateProvider } from '@shell/client/contexts/app-state';
